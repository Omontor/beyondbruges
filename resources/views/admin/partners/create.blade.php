...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.partners.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label class="required" for="lat">{{ trans('cruds.partner.fields.lat') }}</label>
            ...
            <div class="form-group">
                <label class="required" for="lng">{{ trans('cruds.partner.fields.lng') }}</label>
            ...
            <div class="form-group">
                <label for="email">{{ trans('cruds.partner.fields.email') }}</label>
            ...
            <div class="form-group">
                <label class="required" for="owner_id">{{ trans('cruds.partner.fields.owner') }}</label>
                ...
                @endif
                <span class="help-block">{{ trans('cruds.partner.fields.owner_helper') }}</span>
            </div>
            <div class="form-group">
          ...
          return loader.file
            .then(function (file) {
              return new Promise(function(resolve, reject) {
                ...
                xhr.open('POST', '{{ route('admin.partners.storeCKEditorImages') }}', true);

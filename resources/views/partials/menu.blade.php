        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                @can('asset_management_access')
                    <li class="nav-item has-treeview {{ request()->is("admin/prizes*") ? "menu-open" : "" }} {{ request()->is("admin/redeems*") ? "menu-open" : "" }}">
                        <a class="nav-link nav-dropdown-toggle" href="#">
                        ...
                        <ul class="nav nav-treeview">
                            @can('prize_access')
                                <li class="nav-item">
                                    <a href="{{ route("admin.prizes.index") }}" class="nav-link {{ request()->is("admin/prizes") || request()->is("admin/prizes/*") ? "active" : "" }}">
                            ...
                            @can('redeem_access')
                                <li class="nav-item">
                                    <a href="{{ route("admin.redeems.index") }}" class="nav-link {{ request()->is("admin/redeems") || request()->is("admin/redeems/*") ? "active" : "" }}">
